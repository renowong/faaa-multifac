...
require_once('facture_repas_top.php');
...
<html>
	<head>
		...
		$.get("facture_repas_submit.php",{fdata:fdata,clientid:clientid,period:period},
		      function(data){
			readResponse(data);
		      },"xml");
              //alert(data);
		...
		function readResponse(data){
			...
			window.location="facture_repas.php?success="+factureid;
		}
